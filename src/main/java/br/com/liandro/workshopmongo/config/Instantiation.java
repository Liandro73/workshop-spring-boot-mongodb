package br.com.liandro.workshopmongo.config;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Parti viagem", "Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
